...
from .serializers import ConversationListSeriallizer , ConversationDetailSerializer

from useraccount.models import User

@api_view(['GET'])
def conversations_list(request):
    serializer = ConversationListSeriallizer(request.user.conversations.all() , many=True)
